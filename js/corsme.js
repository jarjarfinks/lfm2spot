function getRadio(radioType) {
	...
	var url = "https://crossorigin.me/" + "http://www.last.fm/player/station/user/" + username + radioType;
...
function getSimilarArtist(artist) {
	...
	var url = "https://crossorigin.me/" + "http://www.last.fm/player/station/music/" + artist;
	console.log("- Request URL generated: " + url);
	var request = new XMLHttpRequest();
	console.log("- Request Generated");
	request.open('GET', url, true);
